...
/**
 * Title   CuratorWatcher1.java
 * Descr   验证curator的NodeCacheListener监听器区监听节点的新增和修改操作。
 * Email   lquan.liu@outlook.com 
 * @author lquan
 * @dates  2017年11月6日 上午3:57:43
 */
public class CuratorWatcher1 {
	
	/** zookeeper地址 */
	//static final String CONNECT_ADDR = "192.168.1.171:2181,192.168.1.172:2181,192.168.1.173:2181";
	static final String CONNECT_ADDR = "192.168.207.6:2181";
	/** session超时时间 */
	...
	public static void main(String[] args) throws Exception {
		...
		.forPath("/aaaa/bbb/ccc", "**CC**".getBytes());
